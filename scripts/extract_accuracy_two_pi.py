...
def create_pandas_from_data(path):
    ...
    return df
# CHEB_POLY_7two_pi_num_inc
df_tay_orig = create_pandas_from_data('results/accuracy/TAYLOR_C_ORIGINAL_7two_pi_num_inc.txt')
print(df_tay_orig)

df_tay_opti_7 = create_pandas_from_data('results/accuracy/TAYLOR_CPP_OPTIMIZED_7two_pi_num_inc.txt')
print(df_tay_opti_7)

df_cheb_poly_7 = create_pandas_from_data('results/accuracy/CHEB_POLY_7two_pi_num_inc.txt')
print(df_cheb_poly_7)

df_tay_opti_11 = create_pandas_from_data('results/accuracy/TAYLOR_CPP_OPTIMIZED_11two_pi_num_inc.txt')
print(df_tay_opti_11)

df_cheb_poly_11 = create_pandas_from_data('results/accuracy/CHEB_POLY_11two_pi_num_inc.txt')
print(df_cheb_poly_11)

df_tay_opti_15 = create_pandas_from_data('results/accuracy/TAYLOR_CPP_OPTIMIZED_15two_pi_num_inc.txt')
print(df_tay_opti_15)

df_cheb_poly_15 = create_pandas_from_data('results/accuracy/CHEB_POLY_15two_pi_num_inc.txt')
