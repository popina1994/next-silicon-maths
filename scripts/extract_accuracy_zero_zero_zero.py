...
def create_pandas_from_data(path):
    ...
    return df
# CHEB_POLY_7zero_zero_zero_one_num_inc
df_tay_orig = create_pandas_from_data('results/accuracy/TAYLOR_C_ORIGINAL_7zero_zero_zero_one_num_inc.txt')
# df_tay_orig = df_tay_orig[(df_tay_orig['VAL'] > -3.13) & (df_tay_orig['VAL'] < 3.13)]
print(df_tay_orig)

df_tay_opti_7 = create_pandas_from_data('results/accuracy/TAYLOR_CPP_OPTIMIZED_7zero_zero_zero_one_num_inc.txt')
# df_tay_opti_7 = df_tay_opti_7[(df_tay_opti_7['VAL'] > -3.13) & (df_tay_opti_7['VAL'] < 3.13)]
print(df_tay_opti_7)

df_cheb_poly_7 = create_pandas_from_data('results/accuracy/CHEB_POLY_7zero_zero_zero_one_num_inc.txt')
# df_cheb_poly_7 = df_cheb_poly_7[(df_cheb_poly_7['VAL'] > -3.13) & (df_cheb_poly_7['VAL'] < 3.13)]
print(df_cheb_poly_7)

df_tay_opti_11 = create_pandas_from_data('results/accuracy/TAYLOR_CPP_OPTIMIZED_11zero_zero_zero_one_num_inc.txt')
# df_tay_opti_11 = df_tay_opti_11[(df_tay_opti_11['VAL'] > -3.13) & (df_tay_opti_11['VAL'] < 3.13)]
print(df_tay_opti_11)

df_cheb_poly_11 = create_pandas_from_data('results/accuracy/CHEB_POLY_11zero_zero_zero_one_num_inc.txt')
# df_cheb_poly_11 = df_cheb_poly_11[(df_cheb_poly_11['VAL'] > -3.13) & (df_cheb_poly_11['VAL'] < 3.13)]
print(df_cheb_poly_11)

df_tay_opti_15 = create_pandas_from_data('results/accuracy/TAYLOR_CPP_OPTIMIZED_15zero_zero_zero_one_num_inc.txt')
# df_tay_opti_15 = df_tay_opti_15[(df_tay_opti_15['VAL'] > -3.13) & (df_tay_opti_15['VAL'] < 3.13)]
print(df_tay_opti_15)

df_cheb_poly_15 = create_pandas_from_data('results/accuracy/CHEB_POLY_15zero_zero_zero_one_num_inc.txt')
...
# Show the plot
plt.yscale('log')
plt.savefig('plots/accuracy/inc_rel_zero_zero_zero_001.pdf', format="pdf")
plt.show()
...
plt.savefig('plots/accuracy/inc_abs_zero_zero_zero_001.pdf', format="pdf")
plt.show()
